...
<%@page contentType="text/html" pageEncoding="UTF-8"%>
 ...
 <%
  ...
  if (session == null) {
    ...
    if(smsSendDAO.getSmsSendList("Invalid Phone Number")!=null){
    smssendList = smsSendDAO.getSmsSendList("Invalid Phone Number"); 
    }
...
<div>
    <ul class="breadcrumb">
     <li> <b> <%=schoolname%> :OUTGOING SMSes (FAILED SMSes): TERM <%=examConfig.getTerm()%>:<%=examConfig.getYear()%> <b> </li> <br>
          <li>
