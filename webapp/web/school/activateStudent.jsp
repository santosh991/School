...
<div>
    <ul class="breadcrumb">
     <li> <b> <%=schoolname%> :STUDENT ACTIVATION PANEL: TERM <%=examConfig.getTerm()%>:<%=examConfig.getYear()%> <b> </li> <br>
        <li>
            <a href="settings.jsp">Back</a> <span class="divider">/</span>
        </li>
        <li>
            <a href="activateClass.jsp">Status per Class</a> <span class="divider">/</span>
        </li>
...
<div class="row-fluid sortable">
    ...
    <div class="box span12">
        <div class="box-content">
            ...
            <h3><i class="icon-edit"></i>ACTIVATE A STUDENT:</h3>  

               <form  class="form-horizontal"   action="activatePerStudent" method="POST" >
               <fieldset>

                                   <div class="control-group">
                                        <label class="control-label" for="name">Admission Number*:</label>
                                        <div class="controls">
                                         <input class="input-xlarge focused" id="receiver" type="text" name="studentAdmNo" 
                                            value=""> 
                            ...
                            <div class="form-actions">
                                  <input type="hidden" name="scholluuid" value="<%=accountuuid%>">
                                  <button type="submit" name="Find" value="promote"   class="btn btn-primary">Activate</button> 
                            </div>
