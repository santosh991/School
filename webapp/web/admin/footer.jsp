...
%>
     ...
     <div>
     <footer>
    <p class="pull-left">Copyright  &copy; <%= Calendar.getInstance().get(Calendar.YEAR)%> FasTech Solutions Ltd: </p>
    </footer>
    </div>
...
<script src="../js/displayOtherDetails.js" type="text/javascript"></script>
...
<script src="../js/fastech/excanvas.js"></script>
