...
public class ReturnBook extends HttpServlet{
	...
	final String SUCCESS_BOOK_BORROWED = "The book was successfully returned";
	final String ERROR_BOOK_NOT_BORROWED = "Something went wrong while returning the book";
