...
public class FindStudentOM extends HttpServlet{
   ...
   protected void doPost(HttpServletRequest request, HttpServletResponse response)
       ...
       if(StringUtils.isBlank(admissionNumber)){
		     session.setAttribute(SessionConstants.STUDENT_ADD_OTHER_MONIES_ADD_ERROR, ERROR_NO_ADMNO); 
		   
	   }else if(studentDAO.getStudentObjByadmNo(schoolUuid,admissionNumber)==null){ 
		   session.setAttribute(SessionConstants.STUDENT_ADD_OTHER_MONIES_ADD_ERROR, ERROR_STUDENT_NOT_FOUND); 
	       ...
	       session.setAttribute(SessionConstants.STUDENT_ADD_OTHER_MONIES_ADD_SUCCESS, STUDENT_FIND_SUCCESS);     
	   } 
       session.setAttribute(SessionConstants.STUENT_O_M_PARAM, studentHash); 
