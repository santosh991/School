 ...
 */
package com.yahoo.petermwenda83.server.servlet.paypal;

import javax.net.ssl.HttpsURLConnection;
import javax.servlet.http.HttpServletRequest;

import com.yahoo.petermwenda83.bean.paypal.IpnConfig;
import com.yahoo.petermwenda83.bean.paypal.IpnInfo;
import com.yahoo.petermwenda83.server.paypal.IpnException;
import com.yahoo.petermwenda83.server.paypal.IpnInfoService;
 ...
 *
 *Instant Payment Notification (IPN) is PayPal's message service that sends a notification
 * when a transaction is affected. Basically it's a url that gets called by PayPal once 
 * a transaction has been successfully completed.
 *  This allows your code to do something (send a mail, write to a log...) once the user has made a purchase to PayPal.
 * 
 */
