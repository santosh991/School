...
public class PocketDepositDAO extends DBConnectDAO implements StudentPocketDepositDAO {
	...
	/**
	 * @see com.yahoo.petermwenda83.persistence.money.StudentPocketDepositDAO#getPocketMoney(java.lang.String)
	 */
	@Override
	...
	/**
	 * @see com.yahoo.petermwenda83.persistence.money.StudentPocketDepositDAO#getAllBalanaces()
	 */
	@Override
