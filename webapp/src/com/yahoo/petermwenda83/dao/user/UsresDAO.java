...
public class UsresDAO extends DBConnectDAO implements SystemUsersDAO {
   ...
   private static UsresDAO usresDAO;
	...
	/**
	 * @see com.yahoo.petermwenda83.dao.user.SystemUsersDAO#getUser(java.lang.String)
	 */
	...
	/**
	 * @see com.yahoo.petermwenda83.dao.user.SystemUsersDAO#editUser(com.yahoo.petermwenda83.contoller.user.User, java.lang.String)
	 */
	...
	/**
	 * @see com.yahoo.petermwenda83.dao.user.SystemUsersDAO#putUser(com.yahoo.petermwenda83.contoller.user.User)
	 */
	...
	/**
	 * @see com.yahoo.petermwenda83.dao.user.SystemUsersDAO#deleteUser(com.yahoo.petermwenda83.contoller.user.User)
	 */
	...
	/**
	 * @see com.yahoo.petermwenda83.dao.user.SystemUsersDAO#getAllUsers()
	 */
	...
	/**
	 * @see com.yahoo.petermwenda83.dao.user.SystemUsersDAO#getUserName(com.yahoo.petermwenda83.bean.users.User)
	 */
	@Override
